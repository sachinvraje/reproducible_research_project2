...
```r
dataProcess <- TRUE
setwd("/Users/Sachin/coursera/reproducible_research_project2/")
...
if ( file.exists("StormData.csv.bz2") & !file.exists("StormData.csv")) {
   library(R.utils)
...
## 1          0        0 1996               Snow & Ice     380000      38000      418000
## 2          0        0 1996                  Tornado     100000          0      100000
## 3          0        0 1996 Thunderstorm & Lightning       3000          0        3000
## 4          0        0 1996 Thunderstorm & Lightning       5000          0        5000
## 5          0        0 1996 Thunderstorm & Lightning       2000          0        2000
```
...
```
##        fatalities injuries year damageSource propDamage cropDamage damageTotal
## 653526          0        0 2011 Wind & Storm          0          0           0
## 653527          0        0 2011 Wind & Storm          0          0           0
## 653528          0        0 2011 Wind & Storm          0          0           0
## 653529          0        0 2011   Snow & Ice          0          0           0
## 653530          0        0 2011   Snow & Ice          0          0           0
```
...
![plot of chunk unnamed-chunk-12](https://github.com/TomLous/coursera-reproducible-research-peer-assessment2/blob/master/stormDataAnalysis_files/figure-html/unnamed-chunk-12.png) 
...
![plot of chunk unnamed-chunk-14](https://github.com/TomLous/coursera-reproducible-research-peer-assessment2/blob/master/stormDataAnalysis_files/figure-html/unnamed-chunk-14.png) 
